...
// const Navbar = () => {
//     return (
//         <StyledWrapper className='flex justify-center bg-black'>
//             <div className='navbar text-center flex justify-center mt-5 '>
...
const Navbar = () => {
  return (
    <StyledWrapper className='flex justify-center bg-black py-4'>
      <div className='navbar text-center flex justify-center'>
        <div className="button-container">
          <Link to="/">
            <button className="button">
              <svg className="icon" stroke="currentColor" fill="currentColor" strokeWidth={0} viewBox="0 0 1024 1024" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
