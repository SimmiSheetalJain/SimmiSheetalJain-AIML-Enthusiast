...
const CardContainer = () => {
  return (
    // <StyledWrapper>
    //   <div className="card">
    //     <a href="https://www.instagram.com/simmi_sheetal_jain/" className="socialContainer containerOne">
    ...
    //       </svg>
    //     </a>
    //     <a href="https://x.com/SheetalSimmi" className="socialContainer containerTwo">
    ...
    //       </svg>
    //     </a>
    //     <a href="https://www.linkedin.com/in/sheetal-jain-0030001b5/" className="socialContainer containerThree">
    ...
    <div>
          <div>
            {/* <p className="text-[16px] md:text-[24px] font-bold border-b-4 border-blue-500 pb-3 text-white flex justify-center">
              Find Me Elsewhere
            </p> */}
            <div className="grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-4 mt-5 gap-4 text-[40px] text-white">
              <a
...
const StyledWrapper = styled.div`
  ...
  /* instagram*/
  .containerOne:hover {
    background-color:rgb(240, 89, 18);
    transition-duration: 0.3s;
    transform: scale(1.5);
    border-radius: 15px;
  }
